...
const About = () => {
  return (
    <>
        ...
        <main>
            <section class="home__1">
                <div class="container">
                    <div class="col-2">
                        <img src={img1} alt="" class="img_1"/>
                    </div>
                    <div class="col-2 pr-80 sm-pr-80">
                        <h2 class="head__2 mb-30 text__tertairy">What do we do</h2>
                        <p class="p__2 mb-20">
            ...
            <section class="home__1">
                <div class="container">
                    <div class="col-2">
                        <h2 class="head__2 mb-30 text__tertairy">Our Mission</h2>
                        <p class="p__2 mb-20 pr-40 sm-pr-40">
                        ...
                        {/* <!-- <button class="btn btn__primary">Order A Drug Test</button> --> */}
                    </div>
                    <div class="col-2">
                        <img src={img2} alt="" class="img_1"/>
                    </div>
                </div>
            </section>
        </main>
